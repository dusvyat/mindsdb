...
class HuggingFaceInfereceHandler(BaseMLEngine):
    """
    HuggingFaceInfereceHandler is a MindsDB integration with Writer API LLMs that allows users to run question answering
